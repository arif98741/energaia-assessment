...
<div class="container">
    <div class="row">
        <div class="col-md-offset-4 col-md-8 mt-4">
            <div class="panel panel-default">
                <div class="panel-heading bg-primary">Supplier Login</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/supplier/login') }}">
                        {{ csrf_field() }}
